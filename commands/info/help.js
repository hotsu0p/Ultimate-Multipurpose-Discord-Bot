  ...
  async execute(client, message, args, ee, prefix) {
    ...
    try {
      if (args[0]) {
        ...
        if (cmd.name) embed.addField("**<:x_arrow:1118895954607751218> Command name**", `\`\`\`${cmd.name}\`\`\``);
        if (cmd.description) embed.addField("**<:x_arrow:1118895954607751218> Description**", `\`\`\`${cmd.description}\`\`\``);
        if (cmd.aliases) try {
          embed.addField("**<:x_arrow:1118895954607751218> Aliases**", `\`\`\`${cmd.aliases.map((a) => `${a}`).join("`, `")}\`\`\``);
        } catch {}
        if (cmd.cooldown) embed.addField("**<:x_arrow:1118895954607751218> Cooldown**", `\`\`\`${cmd.cooldown} Seconds\`\`\``);
        if (cmd.usage) {
          embed.addField("**<:x_arrow:1118895954607751218> Usage**", `\`\`\`${prefix}${cmd.usage}\`\`\``);
        ...
        let OverviewEmbed = new MessageEmbed()
          ...
          .setFooter("Thx 2 CoeX Development Team For Code",`https://images-ext-2.discordapp.net/external/wjzN1Pi7whWSGbXgrA-3YAYUjg8PxPBubBdfNphwGCg/%3Fsize%3D44%26quality%3Dlossless/https/cdn.discordapp.com/emojis/936918365304414219.gif`)
